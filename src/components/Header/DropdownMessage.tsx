    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      <li className="relative">
        <Link
          ...
          className="relative flex h-12.5 w-12.5 items-center justify-center rounded-full bg-[#F5F7FA]"
          to="#"
        >
        ...
        {dropdownOpen && (
          <div
            className={`absolute -right-27 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default`}
          >
